...
export interface CommonParams {
     ...
     */
    webpackConfig?: string | Omit<WebpackConfiguration, 'resolve' | 'module' | 'plugin' | 'resolveLoader' | 'node' | 'mode' | 'devtool' | 'output' | 'entry' | 'performance' | 'optimization'>;
    /**
...
export interface StartParams extends CommonParams {
     ...
     */
    webpackDevServerConfig?: string | Omit<WebpackDevServerConfiguration, 'hot' | 'compress' | 'contentBase' | 'stats'>;
    /**
     * logfile path.
     *
