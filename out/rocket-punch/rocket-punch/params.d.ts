...
export declare type BuildMessages = {
    type: 'begin';
    packageName: string;
    sourceDir: string;
    outDir: string;
...
export declare type PublishMessages = {
    type: 'exec';
    command: string;
    publishOption: AvailablePublishOption;
};
export declare type ViewMessages = {
    type: 'view';
    metadata: FullMetadata;
    tags: Record<string, string>;
    packageConfig: PackageInfo;
};
export declare type DoctorMessages = {
    type: 'depcheck';
    result: Results;
} | {
    type: 'tsconfig';
...
export interface BuildParams extends CommonParams {
     ...
     */
    transformCompilerOptions?: (packageName: string) => (computedCompilerOptions: ts.CompilerOptions) => ts.CompilerOptions;
    /**
     * [advanced] you can transform the compilerHost of typescript compiler before emit
     */
    transformCompilerHost?: (packageName: string) => (compilerOptions: ts.CompilerOptions, compilerHost: ts.CompilerHost) => ts.CompilerHost;
    /**
